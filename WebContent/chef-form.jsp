...
<div class="container">
	...
	<div class="card-body">
		...
		<c:if test="${chef != null}">
			<input type="hidden" name="chef_id" value="<c:out value='${chef.id}' />" />
		</c:if>
		...
		<fieldset class="form-group">
			...
			<input type="text" value="<c:out value='${ chef.first_name }'/>" 
		...
		<fieldset class="form-group">
			...
			<input type="text" value="<c:out value='${ chef.last_name }'/>" 
