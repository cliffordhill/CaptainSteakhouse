	...
	<div class="card-body">
		...
		<c:if test="${menu != null}">
			<input type="hidden" name="menu_id"
				value="<c:out value='${menu.menu_id}' />" />
		</c:if>
		...
		<fieldset class="form-group">
			<label>Category</label> <input type="text"
				value="<c:out value='${ menu.category_name}'/>" class="form-control"
				name="category_name">
		...
		<fieldset class="form-group">
			...
			<label>Dish Name</label> <input type="text"
				value="<c:out value='${ menu.item_name}'/>" class="form-control"
		...
		<fieldset class="form-group">
			...
			<label>Price</label> <input type="double"
